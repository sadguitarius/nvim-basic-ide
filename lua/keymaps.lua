...
-- Clear highlights
maps.n["<Esc>"] = { "<cmd>nohlsearch<cr>", desc = "Clear highlights" }
...
maps.n["<leader>fk"] = { ":Telescope keymaps<CR>", desc = "Find keymaps" }
maps.n["<leader>fr"] = { ":Telescope oldfiles<CR>", desc = "Find oldfiles" }
maps.n["<leader>fh"] = { ":Telescope help_tags<CR>", desc = "Find help tags" }
maps.n['<leader>f"'] = { ":Telescope registers<CR>", desc = "Find registers" }
maps.n["<leader>fc"] = { ":Telescope commands<CR>", desc = "Find commands" }
maps.n["<leader>fs"] = { ":Telescope scdoc<CR>", desc = "Find scdoc" }
...
maps.n["<Leader>c"] = { ":cd %:h<CR>", desc = "set cwd to current buffer dir" }

-- Terminal
maps.n["<leader>tp"] = { "<cmd>lua _PWSH_TOGGLE()<cr>", desc = "pwsh toggle" }
maps.n["<leader>td"] = { "<cmd>lua _PWSH_DEV_TOGGLE()<cr>", desc = "pwsh dev toggle" }
maps.n["<leader>tm"] = { "<cmd>lua _MINGW64_TOGGLE()<cr>", desc = "MINGW64 toggle" }
maps.n["<leader>tf"] = { "<cmd>ToggleTerm direction=float<cr>", desc = "float term" }
maps.n["<leader>th"] = { "<cmd>ToggleTerm size=10 direction=horizontal<cr>", desc = "horizontal term" }
maps.n["<leader>tv"] = { "<cmd>ToggleTerm size=80 direction=vertical<cr>", desc = "vertical term" }

-- Edit Config
maps.n["<leader>,"] = { "<cmd>e $MYVIMRC <CR>", desc = "edit vimrc" }

-- Mouse Wheel Scrolling
maps.n["<C-ScrollWheelUp>"] = { "3zh", desc = "scroll left" }
maps.n["<C-ScrollWheelDown>"] = { "3zl", desc = "scroll right" }
